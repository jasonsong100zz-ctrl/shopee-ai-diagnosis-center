...
const elements = Object.fromEntries(["sheetUrl", "bridgeUrl", "workspaceId", "status", "progress", "failures", "start", "resume", "retry", "stop"].map((id) => [id, document.getElementById(id)]));
